...
if __name__ == "__main__":
	df_test = load_and_window_inD(step=25, window_size=35, stride=35, scenes=[1], path='inD-dataset-v1.1/data')
	df_test.to_pickle('inD_test.pickle')

	df_train = load_and_window_inD(step=25, window_size=35, stride=35, scenes=[2, 3, 4], path='inD-dataset-v1.1/data')
